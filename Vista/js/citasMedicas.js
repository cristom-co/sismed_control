...
$('#txfFecha').datetimepicker({
	timepicker: false,
    format: 'Y-m-d'
});

$.post(url_base+'/citasMedicas/listarCitasMedicas', {}, function (data) {
...
$('#btnFecha').click(function () {
    ...
    $.post(url_base+'/citasMedicas/listarCitasMedicasBeneficiario', {fecha:fecha}, function (data) {
        var datos = JSON.parse(data);
        var cont = 0;
        if (datos != false) {
            var filas;  
