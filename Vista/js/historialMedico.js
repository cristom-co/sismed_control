...
$.post(url_base+'/citasMedicas/listarCitasMedicasAtentidas', {}, function (data) {
    ...
    $.each(datos, function (i, v) {
        ...
        filas += "<td>";
        filas += "<form action='" + url_base + "/consultas/editarConsulta' method='POST'>";
        filas += "<button class='btn btn-xs btn-warning center-block' title='Editar' type='submit' name='btnConstulaCitaMedica'><i class='fa fa-stethoscope'></i></button>";
        filas += "<input type='hidden' name='idCitaMedica' value='" + v.idCitaMedica + "'>";
        filas += "</form>";
        filas += "</td>";
        filas += "<td>";
        filas += "<form action='" + url_base + "/consultas/listarConsulta' method='POST'>";
        filas += "<button class='btn btn-xs btn-success center-block' title='Consulta' type='submit' name='btnConstulaCitaMedica'><i class='fa fa-list-alt'></i></button>";
        filas += "<input type='hidden' name='idCitaMedica' value='" + v.idCitaMedica + "'>";
    ...
    $.post(url_base+'/citasMedicas/listarCitasMedicasBeneficiario', {beneficiario:beneficiario}, function (data) {
        ...
        if (datos != false) {
            ...
            $.each(datos, function (i, v) { 
                ...
                filas += "<button class='btn btn-xs btn-warning' type='submit' title='Consulta' name='btnConstulaCitaMedica'><i class='fa fa-stethoscope'></i></button>";
                filas += "<input type='hidden' name='idCitaMedica' value='" + v.idCitaMedica + "'>";
                filas += "<input type='hidden' name='idBeneficiario' value ='" + v.idBeneficiario + "'>"; //idBeneficiario para la insercion del episodio
                filas += "</form>";
                filas += "</td>";
                ...
                filas += "<button class='btn btn-xs btn-success' type='submit' title='Editar' name='btnEditarCitaMedica'><i class='fa fa-edit'></i></button>";
                filas += "<input type='hidden' name='idCitaMedica' value='" + v.idCitaMedica + "'>";
                filas += "</form>";
                filas += "</td>";
                filas += "<td>";
                filas += "<button class='btn btn-xs btn-danger' data-toggle='modal' title='Cancelar' data-target='#modalCancelarCitaMedica" + cont + "' name='btnModalCancelarCitaMedica'><i class='fa fa-close'></i></button>";
